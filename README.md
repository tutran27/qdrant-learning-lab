...
| Lab 04 | `documents_lab06` |

> Ghi chú: Lab 04 hiện vẫn dùng collection suffix `_lab06` trong code cũ. Có thể đổi sang `_lab04` sau nếu muốn đồng bộ tuyệt đối, nhưng cần ingest lại dữ liệu.
