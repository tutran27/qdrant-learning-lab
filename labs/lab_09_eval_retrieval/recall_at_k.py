...
from labs.lab_09_eval_retrieval.retrieve import retrieve

def evaluate_recall_at_k(client, dense_model,query, relevant_pages, top_n: int = 5):  
    if not relevant_pages:
        return 0.0
    retrieved_points = retrieve(client, dense_model,query, top_n)
...
def evaluate_recall(client , dense_model, path = r"labs\lab_09_eval_retrieval\eval_set.json",top_n: int = 5):
